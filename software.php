...
The non-synonymous Single Nucleotide Polymorphisms (SNPs) are of significance in genetic improvement programs as they might affect function of protein products. Here, we report a database of SNPs in annotated transcripts of shrimp, dbVAST for two shrimp species, <i>Penaeus indicus</i> and <i>Penaeus vannamei</i>. The dbVAST database is built with annotated transcripts, SNPs in annotated transcripts and blast statistics of annotated transcripts in three shrimp species. The dbVAST is intended to benefit researchers by showcasing variations in the candidate transcripts of shrimp.
</font>
</div>
<div style="font-size:26px" >
<b>Input</b><br>
The dbVAST is a retrievable database of coding Single Nucleotide Polymorphisms in two shrimp species. Users have to select a shrimp species and submit a query sequence in which he/she is interested to know SNP positions.
<br><b>Output</b><br>
A blastn search is performed for the query sequence against reference transcripts of respective shrimp species. The blastn search identifies the most similar reference transcript of respective shrimp species in the database. Then the following information is displayed on screen which can be downloaded.</li>
<li>The high quality SNPs in the reference transcript that is more similar to query sequence.</li>
<li>The blast statistics of the reference transcript against non-redundant protein database of NCBI &
<li>The sequence of the reference transcript.</li><br>
